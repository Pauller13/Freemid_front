...
import { RoleComponent } from './presentations/freemid/role/role.component';
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'dashboard',
        loadComponent: () => import('./presentations/pages/client/dashboard/dash-analytics.component'),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./presentations/pages/client/account-management/account-management.component').then((m) => m.AccountManagementComponent),
      ...
      {
        path: 'new-offer',
        loadComponent: () => import('./presentations/pages/client/offre/new-offer/new-offer.component').then((m) => m.NewOfferComponent),
      ...
      {
        path: 'offers-list',
        loadComponent: () => import('./presentations/pages/client/offre/offer-list/offer-list.component').then((m) => m.OfferListComponent),
      ...
      {
        path: 'offer-edit',
        loadComponent: () => import('./presentations/pages/client/offre/offer-edit/offer-edit.component').then((m) => m.OfferEditComponent),
        canActivate: [AuthGuard],
        data: { roles: ['client'] }
      },
      {
        path: 'offer-proposals',
        loadComponent: () => import('./presentations/pages/client/offre/detail-offer/detail-offer.component').then((m) => m.DetailOfferComponent),
      ...
      },
      {
        ...
        loadComponent: () => import('./presentations/pages/client/freelancer-list/freelancer-list.component').then(m => m.FreelancerListComponent),
        canActivate: [AuthGuard],data: { roles: ['client'] }
      },
      {
      path: 'freelancer-profile/:name',
      loadComponent: () => import('./presentations/pages/client/freelancer-profile/freelancer-profile.component').then(m => m.FreelancerProfileComponent),
      canActivate: [AuthGuard],data: { roles: ['client'] }
      },
      {
        path: 'my-profile',
        loadComponent: () => import('./presentations/pages/client/my-profil-client/my-profil-client.component').then((m) => m.MyProfilClientComponent),
        title: "Mon Profile",
        canActivate: [AuthGuard],
        data: { roles: ['client'] }
      },
      {
        ...
        loadComponent: () =>
          import('./presentations/pages/client/client-collaborator/client-collaborator.component').then((m) => m.ClientCollaboratorComponent),
        canActivate: [AuthGuard],
        data: { roles: ['client'] }
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'role',
        loadComponent: () => import('./presentations/freemid/role/role.component').then((m) => m.RoleComponent)
      },
      {
        path: 'freemid',
